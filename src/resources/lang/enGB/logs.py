...
logDescNest_checkingAuth = 'Checking Auth Token'
logDescNest_streamStart = 'Nest stream started'
logDescNest_streamUpdate = 'Nest stream update received'
logDescNest_streamError = 'Nest stream error'
